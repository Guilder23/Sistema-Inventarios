/**
 * modal_exportar.js - Lógica para el modal de exportación de contenedores
...
function confirmarExportacion() {
    ...
    setTimeout(() => {
        exportarTablaContenedores(columnasSeleccionadas);
    }, 300);
}

/**
 * Exportar tabla de contenedores a Excel/CSV
 * Usa punto y coma (;) como separador para mejor compatibilidad con Excel en español
 */
function exportarTablaContenedores(columnasSeleccionadas = null) {
